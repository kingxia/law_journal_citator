...
INSERT_CITATION = 'INSERT INTO citations (id, journalId, volume, page, caseId, caseName, jurisdiction, year, startPos, endPos, frontendUrl) VALUES (%d, %d, %d, %d, %d, "%s", %d, %d, %d, %d, "%s");'
